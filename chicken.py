...
class Player(pygame.sprite.Sprite):
    ...
    def update(self , walls, enemies, goals):
        ...
        #     if pygame.sprite.collide_rect_ratio(0.67)(self, enemy):
        #         self.rect.x = PLAYER_X0
        #         self.rect.y = PLAYER_Y0
        #         self.death_sound.play()
        #         self.death_count += 1
...
class Level1(Level):
    def __init__(self, goals = 1):
        ...
        #goal = Goal(PLAYER_X0+100, PLAYER_Y0)
...
class Level3(Level):
    def __init__(self, goals = 1):
        ...
        enemies = [
            ...
            # 6 blocos
            [600, 320, 5, 4, 50, 1, 3],
            [SCREEN_WIDTH-100, 320, -5, 4, 50, 1, 3],
            
            [600, 520, 6, 5, 50, 0.8, 3],
            [SCREEN_WIDTH-100, 520, -6, 5, 50, 0.8, 3],
            
            [650, 620, 5, 5, 50, 0.6, 3],
            [SCREEN_WIDTH-150, 620, -5, 5, 50, 0.6, 3],
            
            [650, 770, 7, 5, 50, 0.5, 3],
            [SCREEN_WIDTH-150, 770, -7, 5, 50, 0.5, 3],
            
            
            
            [SCREEN_WIDTH/2+50, 0, 0, 6, 75, 2, 1],
